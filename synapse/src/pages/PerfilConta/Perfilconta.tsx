                    ...
                    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        ...
                        <div className="flex w-full max-w-md flex-col gap-3">
                            <input
                                type="file"
                                accept="image/*"
                                className="rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-sm text-slate-300 file:mr-3 file:rounded-md file:border-0 file:bg-cyan-500 file:px-3 file:py-1.5 file:text-sm file:font-semibold file:text-slate-950"
                            />
                            <button
                                type="button"
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-900 p-5">
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                        <input
                            type="text"
                            placeholder="Nome"
                            className="rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-sm outline-none placeholder:text-slate-500"
                        />
                        <input
                            type="email"
                            placeholder="Email"
