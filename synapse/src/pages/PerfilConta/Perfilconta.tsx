                        ...
                        <div className="mx-auto w-full max-w-4xl space-y-6">
                                ...
                                <div className="rounded-xl border border-slate-800 bg-slate-900 p-5">
                                        ...
                                        <div className="grid gap-3 md:grid-cols-2">
                                                <input type="text" placeholder="Nome" className="rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-sm outline-none placeholder:text-slate-500" />
                                                <input type="email" placeholder="Email" className="rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-sm outline-none placeholder:text-slate-500" />
                                        </div>
                                </div>
