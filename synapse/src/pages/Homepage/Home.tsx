    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col">
            <section className="flex flex-col items-center justify-center flex-1 gap-6 py-32 px-6 text-center">
                ...
                <div className="flex gap-4 mt-4">
                    <button
                        ...
                        className="px-6 py-2 rounded-lg bg-cyan-500 text-slate-950 font-semibold hover:bg-cyan-400 transition-colors"
                    >
                        Entrar
                    </button>
                    <button
                        onClick={() => navigate("/cadastro")}
                        className="px-6 py-2 rounded-lg border border-slate-600 text-slate-100 font-semibold hover:bg-slate-800 transition-colors"
                    >
                        Cadastrar
                    </button>
                </div>
            ...
            <section className="flex flex-col items-center gap-4 py-20 border-t border-slate-800 px-6 text-center">
                ...
                <button
                    onClick={() => navigate("/cadastro")}
                    className="mt-4 px-8 py-3 rounded-lg bg-cyan-500 text-slate-950 font-semibold hover:bg-cyan-400 transition-colors text-lg"
                >
                    Começar agora
                </button>
            </section>
